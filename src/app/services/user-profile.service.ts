...
export class UserProfileService {
    ...
    private baseUri(): string{
        ...
        return `${this.authSvc.globalConfig.userProfileServiceConnection}api/v1/user-profile/realm/${this.authSvc.globalConfig.realm}/user-id/${this.authSvc.getUserId()}`
    }
}
