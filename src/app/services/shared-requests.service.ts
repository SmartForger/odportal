...
export class SharedRequestsService {
    ...
    private buildAppData(appId: string): void {
        console.log('Request to build shared request appData for appId: ', appId);
        ...
        console.log(`Requests object for app ${appId}`, appRequests);
        ...
        if (requestsToMake.length > 0) {
            ...
            forkJoin(requestsToMake).subscribe((results) => {
                ...
                console.log('Generating shared request appData: ...', appData);
