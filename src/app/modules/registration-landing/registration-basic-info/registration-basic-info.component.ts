...
import {
  ...
  MessageDialogParams,
} from '../../display-elements/message-dialog/message-dialog.component';
...
export class RegistrationBasicInfoComponent extends CustomForm
        ...
        if (gc) {
          ...
          this.route.queryParamMap.subscribe((queryMap: ParamMap) => {
            ...
            if (queryMap.has(this.authSvc.globalConfig.cacEmailQueryParam)) {
              this.x509Email = queryMap.get(
                this.authSvc.globalConfig.cacEmailQueryParam
              );
            ...
            if (queryMap.has(this.authSvc.globalConfig.cacCNQueryParam)) {
              this.x509CN = decodeURI(
                queryMap.get(this.authSvc.globalConfig.cacCNQueryParam)
              );
            ...
            if (queryMap.has(this.authSvc.globalConfig.cacDNQueryParam)) {
              this.x509DN = queryMap.get(
                this.authSvc.globalConfig.cacDNQueryParam
              );
            }
