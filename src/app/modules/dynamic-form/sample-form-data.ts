          ...
          columns: [
            {
              field: {
                type: 'text',
                label:
                  '10a. IA Training & Awareness Certification Completion Date  (YYYY/MM/DD)',
        ...
        columns: [
          {
            field: {
              ...
              binding: 'cacCertified',
              attributes: {
                required: true,
                options: [
                  {
                    display: 'I certify that this user requires access as requested',
                    value: 'cacCertified'
                  }
                ]
              }
