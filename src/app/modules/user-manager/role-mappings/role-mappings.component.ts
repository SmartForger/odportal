...
export class RoleMappingsComponent
  implements DynamicallyRenderable, OnDestroy, OnInit {
  canManage: boolean;
  get profile(): UserProfileKeycloak {
    return this._profile;
  }
  set profile(profile: UserProfileKeycloak) {
  ...
  private subscribeToSessionUpdate(): void {
    this.sessionUpdateSub = this.authSvc
